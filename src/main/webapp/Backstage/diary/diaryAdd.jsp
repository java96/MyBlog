    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="diary_addDiary" method="post" id="myform" name="myform"
                      enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody>
                        <tr>
                            <th><i class="require-red">*</i>日记标题：</th>
                            <td>
                                <input class="common-text required" id="title" name="diary.diaryTitle" size="50"
                                       value="" type="text">
                            </td>
                        </tr>

                        <tr>
                            <th width="120"><i class="require-red">*</i>推荐日记：</th>
                            <td>
                                <select name="diary.diaryRecommend" id="catid" class="required">
                        ...
                        <tr>
                            <th><i class="require-red">*</i>日记作者：</th>
                            <td><input class="common-text" name="diary.diaryUser" size="50"
                                       value="${sessionScope.admin.username}" type="text"></td>
                        </tr>
                        <tr>
                            <th><i class="require-red">*</i>日记缩略图：</th>
                            <td><input name="diary.diaryImager" id="" type="file"><!--<input type="submit" onclick="submitForm('/jscss/admin/design/upload')" value="上传图片"/>-->
                            </td>
                        </tr>
                        <tr>
                            <th><i class="require-red">*</i>日记内容：</th>
                            <td>
                                <textarea name="diary.diaryText" id="editor1" rows="10" cols="80">
                                </textarea>
                                <script>
