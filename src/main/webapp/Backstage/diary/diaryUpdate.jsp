    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <s:iterator value="#request.Adiary" var="diary">
                    <form action="diary_updateDiary" method="post" id="myform" name="myform"
                        ...
                        <table class="insert-tab" width="100%">
                            ...
                            <tr>
                                ...
                                <td><input class="common-text" name="diary.diaryTime" size="50"
                                           value="${diaryTime}"
                                           type="text"></td>
                            </tr>
                            <tr>
