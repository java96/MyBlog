...
<head>
    <base href="<%=basePath%>">
    <meta charset="gb2312">
    <title>${requestScope.learn.learnTitle}</title>
    ...
    <!--[if lt IE 9]>
    <script src="<%=basePath%>Receptionjs/modernizr.js"></script>
    <![endif]-->
</head>
<body>
<header>
...
<article class="blogs">
    ...
    <s:iterator value="#request.learnList">
        <div class="index_about">
            <h2 class="c_titile">${learnTitle}</h2>

            <p class="box_c">
                <span class="d_time">
                    发布时间：<s:date name="learnCommtime"
                                 format="yyyy-MM-dd"/> </span><span>编写：${learnName}</span>
            </p>
            <ul class="infos">
                    ${learnText}
            </ul>
