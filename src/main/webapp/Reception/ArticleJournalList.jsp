...
<article class="blogs">
    ...
    <s:iterator value="#request.journalList">
        <div class="index_about">
            <h2 class="c_titile">${journalTitle}</h2>

            <p class="box_c"><span class="d_time">发布时间：<s:date name="journalDate" format="yyyy-MM-hh"/></span>
                <span>编辑：${journalUser}</span>
            </p>
            <ul class="infos">
                    ${journalText}
            </ul>
